            ...
            <table class="table text-center compare-content">
                <tbody>
                    <tr>
                        ...
                        <td class="product-description">
                            <div class="compare-details">
                                ...
                                <span>mobile</span>
                                <h4><a href="product.php">Tablat c7 pro</a></h4>
                            </div>
                        </td>
                        <td class="product-description">
                            <div class="compare-details">
                                ...
                                <span>Games</span>
                                <h4><a href="product.php">play station x 22</a></h4>
                            </div>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td class="product-description">
                            <p>Impressively thin and light, the HP EliteBook 840 empowers users to create, connect, and
                                collaborate, using enterprise-class performance</p>
                        </td>
                        <td class="product-description">
                            <p>Impressively thin and light, the HP EliteBook 840 empowers users to create, connect, and
                                collaborate, using enterprise-class performance</p>
                    ...
                    <tr>
                        ...
                        <td class="product-description">
                            <a class="compare-cart text-uppercase" href="cart.php"> + add to cart</a>
                        </td>
                        <td class="product-description">
                            <a class="compare-cart text-uppercase" href="cart.php"> + add to cart</a>
                        </td>
...
<?php $__env->stopSection(); ?>
<!-- Compare Page End -->
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\DoAnTotNghiep\project-Graduation\shop\shop\resources\views/comparepage.blade.php ENDPATH**/ ?>